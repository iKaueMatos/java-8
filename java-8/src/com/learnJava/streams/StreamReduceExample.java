...
public class StreamReduceExample {
  ...
  public static Optional<Integer> performMultiplicationWithNoInitialValue(
    List<Integer> integerList
  ) {
    return integerList.stream().reduce((a, b) -> a * b); // performs multiplication for each element in the stream and returns a new result fo.
  }
  ...
  public static Optional<Student> getHighestGradeStudent() {
    Optional<Student> studentOptional = StudentDataBase
      .getAllStudents()
      .stream()
  ...
  public static void main(String[] args) {
    ...
    Optional<Integer> result = performMultiplicationWithNoInitialValue(
      integerList
    );
